...
const Skills = () => {
  return (
        ...
        id='skill' className='w-full px-[12%] py-40 scroll-mt-20'>
          ...
          className='text-center text-5xl font-ovo'>My Focus</motion.h2>
          <motion.p 
          initial={{opacity: 0}}
          whileInView={{opacity: 1}}
          transition={{duration: 0.5, delay: 0.7}}
          className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>
            I approach projects with a strong foundation in technology and engineering principles, 
            focusing on innovative and efficient solutions.</motion.p>
    
            <motion.div 
            initial={{opacity: 0}}
            whileInView={{opacity: 1}}
            transition={{duration: 0.6, delay: 0.9}}
            className='grid grid-cols-[var(--grid-cols-auto)] gap-6 my-10'>
