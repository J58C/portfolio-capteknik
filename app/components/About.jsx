    ...
    >
      ...
      className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='flex-1'>
            ...
            Currently pursuing a degree in Computer Engineering, I focus on software development, 
            embedded systems, and exploring the latest advancements in tech. From programming 
            microcontrollers to developing applications.</p>
            <motion.ul 
            initial={{opacity: 0}}
            whileInView={{opacity: 1}}
