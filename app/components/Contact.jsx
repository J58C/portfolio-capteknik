...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "b6323df4-2633-4b3c-9066-f8c0ff246c36");
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-110 scroll-mt-40 
    bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>
        ...
        onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            <div className='grid grid-cols-[var(--grid-cols-auto)] gap-6 mt-10 mb-8'>
                <motion.input 
                ...
                className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md 
                bg-white dark:bg-darkHover/30 dark:border-white/90' name='email'/>
            </div>
            <motion.textarea 
            ...
            hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>Submit now 
